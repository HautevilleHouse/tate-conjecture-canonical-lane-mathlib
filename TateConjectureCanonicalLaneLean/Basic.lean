/-!
# tate-conjecture-canonical-lane Lean migration boundary
...
`TateConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "tate-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/tate-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Tate conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-geometry", "arithmetic-geometry", "mathematical-proof", "reproducibility", "algebraic-cycles", "l-adic-cohomology", "tate-conjecture", "canonical-lane", "local-to-global", "manifold-constrained"]
