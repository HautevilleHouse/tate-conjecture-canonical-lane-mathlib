# Tate Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/tate-conjecture-canonical-lane-mathlib.git
cd tate-conjecture-canonical-lane-mathlib
lake exe
lake build
```
